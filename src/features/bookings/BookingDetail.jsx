...
function BookingDetail() {
  const { bookingId, data: booking = {}, isLoading, error } = useBooking();
  ...
  return (
    <>
      ...
      <ButtonGroup>
        ...
        {status === "checked-in" && (
          <Button onClick={handleCheckinOut} disabled={isCheckingOut}>
            Check out
          </Button>
        )}
        ...
        <Modal>
          ...
          <Modal.Window name="delete">
            <ConfirmDelete
              ...
              onConfirm={() =>
                deleteBookingApi(bookingId, { onSettled: () => moveBack() })
              }
              disabled={isDeleting}
            />
          </Modal.Window>
